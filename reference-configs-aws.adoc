...
(dischi + storage a oggetti) ^1^ | 500 GiB | 2 PIB ^2^ | 2 TIB | 10 TIB | 368 TIB ^2^ | 368 TIB per licenza ^2^ 
...
Le larghezze di banda indicate nella tabella sottostante corrispondono ai limiti AWS documentati per ciascun tipo di istanza. Questi limiti non sono completamente in linea con quanto Cloud Volumes ONTAP può fornire. Per le prestazioni previste, fare riferimento a https://www.netapp.com/pdf.html?item=/media/9088-tr4383.pdf["Report tecnico di NetApp 4383: Caratterizzazione delle performance di Cloud Volumes ONTAP nei servizi Web Amazon con carichi di lavoro delle applicazioni"^].
